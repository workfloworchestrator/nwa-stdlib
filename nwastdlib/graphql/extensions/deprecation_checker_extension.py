...
def get_deprecated_paths(type_definition: StrawberryObjectDefinition) -> DeprecatedPaths:
...
def make_deprecation_checker_extension(
    ...
    def deprecations_for(_type: type | None) -> DeprecatedPaths:
        type_def: StrawberryObjectDefinition | None = (
            getattr(_type, "__strawberry_definition__", None) if _type else None
        )
